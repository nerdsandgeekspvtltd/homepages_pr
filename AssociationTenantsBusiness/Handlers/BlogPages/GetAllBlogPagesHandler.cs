...
namespace AssociationBusiness.Handlers
{
    ...
    public class GetBlogPagesRequest : IRequest<BlogPostResponse>
    {
    ...
    /// </summary>
    public class GetAllBlogPagesHandler : IRequestHandler<GetBlogPagesRequest, BlogPostResponse>
    {
        ...
        public async Task<BlogPostResponse> Handle(GetBlogPagesRequest request, CancellationToken cancellationToken)
        {
